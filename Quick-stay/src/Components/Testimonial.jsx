...
const Testimonial = () => {
  return (
    <div className='flex flex-col items-center px-6 m:px-16 lg: px-24 bg-slate-50 pt-20 pb-30'>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mt-20 ">
                {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className="bg-white p-2 rounded-xl shadow max-w-xs">
